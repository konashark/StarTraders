//*********************************************************
function initializePulseWeapon()
{
...
//*********************************************************
function createPulse(originObj)
{
	for (i = 0; i < 10; i++)
	{
...
function updatePulse()
{
	for (i = 0; i < 10; i++)
	{
		...
		if (pulse.active)
		{
			...
			{
createExplosion( pulse.mesh.position.x, pulse.mesh.position.y, pulse.mesh.position.z);				
